    ...
    >
      <div className="modal-box max-w-2xl">
        ...
        <p className="text-sm text-base-content/70 mb-6">
          You are about to process {sessionCount} session{sessionCount !== 1 ? 's' : ''}. Choose how
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-base-content/70 mb-2">
                  Quickly calculate performance, usage, quality, and engagement metrics for all
                  sessions.
                </p>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-base-content/70 mb-2">
                  Calculate core metrics plus AI-generated summaries, quality assessments, and phase
                  analysis.
                </p>
                <ul className="text-xs text-base-content/60 space-y-1">
